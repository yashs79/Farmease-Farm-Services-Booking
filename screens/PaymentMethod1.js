    ...
    <View style={styles.paymentMethod}>
      ...
      <View style={[styles.body, styles.bodyLayout]}>
        <Pressable
          ...
          onPress={() => navigation.navigate("ServiceSuccess")}
        >
          <Image
            style={[styles.rectangleIcon, styles.cardInnerLayout]}
            resizeMode="cover"
        ...
        <View style={styles.paymentmethod}>
          ...
          <View style={[styles.rectangleParent, styles.paymentmethodLayout]}>
            ...
            <View style={styles.creditCardParent}>
              ...
              <Image
                style={[styles.groupInner, styles.cardInnerLayout]}
                resizeMode="cover"
        ...
        <View style={[styles.card, styles.cardLayout]}>
          <Image
            style={[styles.cardChild, styles.cardInnerLayout]}
            resizeMode="cover"
          ...
          />
          <Image
            style={[styles.cardItem, styles.cardInnerLayout]}
            resizeMode="cover"
            source={require("../assets/polygon-4.png")}
          />
          <Image
            style={[styles.cardInner, styles.cardInnerLayout]}
            resizeMode="cover"
          ...
          />
          <Image
            style={[styles.groupIcon, styles.cardInnerLayout]}
            resizeMode="cover"
      ...
      <View style={[styles.wizard, styles.wizardLayout1]}>
        <View style={[styles.ellipseParent, styles.ellipseLayout]}>
          ...
          />
          <Image
            style={[styles.vectorIcon, styles.cardInnerLayout]}
            resizeMode="cover"
      ...
      <View style={styles.actionbar}>
        <View style={styles.rightSide}>
          <Image
            style={[styles.batteryIcon, styles.cardInnerLayout]}
            resizeMode="cover"
