...
const ServiceSuccess = () => {
  ...
  return (
    <View style={styles.serviceSuccess}>
      <Image
      ...
      <View style={styles.body}>
        <View style={styles.vectorParent}>
          ...
          />
          <Text
            style={[styles.yourServiceWas, styles.textTypo]}
          >{`Your Service was 
...
a few minutes.`}</Text>
      ...
      <View style={styles.titlebarPosition}>
        ...
        <Text style={[styles.serviceBookSuccess, styles.youWillGetTypo]}>
          Service Book Success
        </Text>
        <Pressable
